...
- The full methodology, game theory, and findings can be found in the original [24Fa-MPONC]([url](https://github.com/VIP-SMUR/24Fa-MPONC)) repository; it is also pasted below after the *'USER GUIDE'* section, comprising the entire remainder of this README. 
